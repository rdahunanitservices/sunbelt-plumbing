...
### 2. Phone Number
- [ ] Search all files for `(480) 527-5385` and `+14805275385`
...
### 3. Email Address
- [ ] Search all files for `shan@sunbeltplumbingaz.com`
...
- `(480) 527-5385` — all phone number instances
- `shan@sunbeltplumbingaz.com` — all email instances
